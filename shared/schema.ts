...
// Regex for validating matricula format: FS-XXX-XX (X = digit) or legacy admin format
export const matriculaRegex = /^(FS-\d{3}-\d{2}|admin)$/;

export const insertUserSchema = z.object({
  full_name: z.string().min(1, "Full name is required").max(100, "Nome muito longo"),
  matricula: z.string().optional(), // Auto-generated by backend in format FS-XXX-XX
